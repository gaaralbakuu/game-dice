...
<div class="page-container">
        ...
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_rixiaofei_shi]">
                    <?php $__FOR_START_4865__=0;$__FOR_END_4865__=24;for($i=$__FOR_START_4865__;$i < $__FOR_END_4865__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_rixiaofei_shi'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>点</option><?php } ?>
                </select>
                </span>
                <span class="select-box" style="width:80px">
                <select class="select" name="jihua[jihua_rixiaofei_fen]">
                    <?php $__FOR_START_24026__=1;$__FOR_END_24026__=60;for($i=$__FOR_START_24026__;$i < $__FOR_END_24026__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_rixiaofei_fen'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>分</option><?php } ?>
                </select>
                </span>
                </td>
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_rikuisun_shi]">
                    <?php $__FOR_START_13792__=0;$__FOR_END_13792__=24;for($i=$__FOR_START_13792__;$i < $__FOR_END_13792__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_rikuisun_shi'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>点</option><?php } ?>
                </select>
                </span>
                <span class="select-box" style="width:80px">
                <select class="select" name="jihua[jihua_rikuisun_fen]">
                    <?php $__FOR_START_6733__=1;$__FOR_END_6733__=60;for($i=$__FOR_START_6733__;$i < $__FOR_END_6733__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_rikuisun_fen'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>分</option><?php } ?>
                </select>
                </span>
                </td>
                <td>赠送前一天(系统设置->赠送活动)</td>
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_yuexiaofei_shi]">
                    <?php $__FOR_START_9461__=0;$__FOR_END_9461__=24;for($i=$__FOR_START_9461__;$i < $__FOR_END_9461__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_yuexiaofei_shi'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>点</option><?php } ?>
                </select>
                </span>
                <span class="select-box" style="width:80px">
                <select class="select" name="jihua[jihua_yuexiaofei_fen]">
                    <?php $__FOR_START_9444__=1;$__FOR_END_9444__=60;for($i=$__FOR_START_9444__;$i < $__FOR_END_9444__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_yuexiaofei_fen'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>分</option><?php } ?>
                </select>
                </span>
                </td>
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_yuekuisun_shi]">
                    <?php $__FOR_START_11862__=0;$__FOR_END_11862__=24;for($i=$__FOR_START_11862__;$i < $__FOR_END_11862__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_yuekuisun_shi'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>点</option><?php } ?>
                </select>
                </span>
                <span class="select-box" style="width:80px">
                <select class="select" name="jihua[jihua_yuekuisun_fen]">
                    <?php $__FOR_START_31602__=1;$__FOR_END_31602__=60;for($i=$__FOR_START_31602__;$i < $__FOR_END_31602__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_yuekuisun_fen'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>分</option><?php } ?>
                </select>
                </span>
                </td>
                <td>赠送上一个月(系统设置->赠送活动)</td>
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_dailifandian_shi]">
                    <?php $__FOR_START_2104__=0;$__FOR_END_2104__=24;for($i=$__FOR_START_2104__;$i < $__FOR_END_2104__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_dailifandian_shi'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>点</option><?php } ?>
                </select>
                </span>
                <span class="select-box" style="width:80px">
                <select class="select" name="jihua[jihua_dailifandian_fen]">
                    <?php $__FOR_START_13378__=1;$__FOR_END_13378__=60;for($i=$__FOR_START_13378__;$i < $__FOR_END_13378__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_dailifandian_fen'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>分</option><?php } ?>
                </select>
                </span>
                </td>
            ...
            <tr class="text-c">
                ...
                <td>
                    ...
                    <select class="select" name="jihua[jihua_dbautoback_shi]">
                        <?php $__FOR_START_27903__=0;$__FOR_END_27903__=8;for($i=$__FOR_START_27903__;$i < $__FOR_END_27903__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_dbautoback_shi'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>点</option><?php } ?>
                    </select>
                    </span>-->
                    ...
                    <select class="select" name="jihua[jihua_dbautoback_fen]">
                        <?php $__FOR_START_12390__=10;$__FOR_END_12390__=121;for($i=$__FOR_START_12390__;$i < $__FOR_END_12390__;$i+=5){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_dbautoback_fen'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>分钟</option><?php } ?>
                    </select>
                    </span>-->
        ...
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_kaijiang_days]">
                    <?php $__FOR_START_28872__=1;$__FOR_END_28872__=61;for($i=$__FOR_START_28872__;$i < $__FOR_END_28872__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_kaijiang_days'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                </select>
                </span>
                </td>
                <td>最少保留1天的开奖</td>
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_touzhu_days]">
                    <?php $__FOR_START_21904__=45;$__FOR_END_21904__=91;for($i=$__FOR_START_21904__;$i < $__FOR_END_21904__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_touzhu_days'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                </select>
                </span>
                </td>
                <td>最少保留45天</td>
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_fandian_days]">
                    <?php $__FOR_START_9307__=1;$__FOR_END_9307__=61;for($i=$__FOR_START_9307__;$i < $__FOR_END_9307__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_fandian_days'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                </select>
                </span>
                </td>
                <td>最少保留1天</td>
  ...
  <!--          <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_jinjijiangli_days]">
                    <?php $__FOR_START_13249__=1;$__FOR_END_13249__=61;for($i=$__FOR_START_13249__;$i < $__FOR_END_13249__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_jinjijiangli_days'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                </select>
                </span>
                </td>
                <td>最少保留1天</td>
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_fanshui_days]">
                    <?php $__FOR_START_30892__=1;$__FOR_END_30892__=61;for($i=$__FOR_START_30892__;$i < $__FOR_END_30892__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_fanshui_days'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                </select>
                </span>
                </td>
                <td>最少保留1天</td>
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_fuddetail_days]">
                    <?php $__FOR_START_23880__=45;$__FOR_END_23880__=91;for($i=$__FOR_START_23880__;$i < $__FOR_END_23880__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_fuddetail_days'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                </select>
                </span>
                </td>
                <td>最少保留45天</td>
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_memlog_days]">
                    <?php $__FOR_START_12108__=7;$__FOR_END_12108__=31;for($i=$__FOR_START_12108__;$i < $__FOR_END_12108__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_memlog_days'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                </select>
                </span>
                </td>
                <td>最少保留7天</td>
            ...
            <tr class="text-c">
                ...
                <select class="select" name="jihua[jihua_adminlog_days]">
                    <?php $__FOR_START_11243__=7;$__FOR_END_11243__=31;for($i=$__FOR_START_11243__;$i < $__FOR_END_11243__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($setlist['jihua_adminlog_days'] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                </select>
                </span>
                </td>
                <td>最少保留7天</td>
