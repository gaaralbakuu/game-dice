...
<div class="page-container">
 ...
 $opencodes = array(); $opencodes = explode(',',$vo['opencode']); ?>
					...
					<?php if(($typeid) == "ssc"): ?><div style="margin:0 auto;width:26em;">
						<?php $__FOR_START_21895__=0;$__FOR_END_21895__=5;for($i=$__FOR_START_21895__;$i < $__FOR_END_21895__;$i+=1){ ?><select id="opencode<?php echo ($i+1); ?>-<?php echo ($vo["expect"]); ?>" style="padding:2px 1px;width:auto;float:left;margin:1px 2px;">
							<option value="">第<?php echo ($i+1); ?>球</option>
							<?php $__FOR_START_25294__=0;$__FOR_END_25294__=10;for($j=$__FOR_START_25294__;$j < $__FOR_END_25294__;$j+=1){ ?><option value="<?php echo ($j); ?>" <?php if($opencodes[$i] == $j): ?>selected<?php endif; ?>><?php echo ($j); ?></option><?php } ?>
						</select><?php } ?>
					</div><?php endif; ?>
					<!--11选5-->
					<?php if(($typeid) == "x5"): ?><div style="margin:0 auto;width:26em;">
						<?php $__FOR_START_24769__=0;$__FOR_END_24769__=5;for($i=$__FOR_START_24769__;$i < $__FOR_END_24769__;$i+=1){ ?><select id="opencode<?php echo ($i+1); ?>-<?php echo ($vo["expect"]); ?>" style="padding:2px 1px;width:auto;float:left;margin:1px 2px;">
							<option value="">第<?php echo ($i+1); ?>球</option>
							<?php $__FOR_START_24539__=0;$__FOR_END_24539__=12;for($j=$__FOR_START_24539__;$j < $__FOR_END_24539__;$j+=1){ if($j<10)$j='0'.$j?>
					...
					<?php if(($typeid) == "pk10"): ?><div style="margin:0 auto;width:40em;">
						<?php $__FOR_START_32451__=0;$__FOR_END_32451__=10;for($i=$__FOR_START_32451__;$i < $__FOR_END_32451__;$i+=1){ ?><select id="opencode<?php echo ($i+1); ?>-<?php echo ($vo["expect"]); ?>" style="padding:2px 1px;width:50px;float:left;margin:1px 2px;">
							<option value="">第<?php echo ($i+1); ?>球</option>
							<?php $__FOR_START_26938__=0;$__FOR_END_26938__=11;for($j=$__FOR_START_26938__;$j < $__FOR_END_26938__;$j+=1){ if($j<10)$j='0'.$j?>
								<?php if(($j) != "0"): ?><option value="<?php echo ($j); ?>" <?php if($opencodes[$i] == $j): ?>selected<?php endif; ?>><?php echo ($j); ?></option><?php endif; } ?>
						</select><?php } ?>
					</div><?php endif; ?>
					...
					<?php if(($typeid) == "keno"): ?><div style="margin:0 auto;width:40em;">
						<?php $__FOR_START_14305__=0;$__FOR_END_14305__=20;for($i=$__FOR_START_14305__;$i < $__FOR_END_14305__;$i+=1){ ?><select id="opencode<?php echo ($i+1); ?>-<?php echo ($vo["expect"]); ?>" style="padding:2px 1px;width:50px;float:left;margin:1px 2px;">
							<option value="">第<?php echo ($i+1); ?>球</option>
							<?php $__FOR_START_27513__=0;$__FOR_END_27513__=81;for($j=$__FOR_START_27513__;$j < $__FOR_END_27513__;$j+=1){ if($j<10)$j='0'.$j?>
								<?php if(($j) != "0"): ?><option value="<?php echo ($j); ?>" <?php if($opencodes[$i] == $j): ?>selected<?php endif; ?>><?php echo ($j); ?></option><?php endif; } ?>
						</select>
						<?php if($i==9) echo'<br />'; } ?>
					</div><?php endif; ?>
					...
					<?php if(($typeid) == "k3"): ?><div style="margin:0 auto;width:20em;">
						<?php $__FOR_START_7308__=0;$__FOR_END_7308__=3;for($i=$__FOR_START_7308__;$i < $__FOR_END_7308__;$i+=1){ ?><select id="opencode<?php echo ($i+1); ?>-<?php echo ($vo["expect"]); ?>" style="padding:2px 1px;width:auto;float:left;margin:1px 2px;">
							<option value="">第<?php echo ($i+1); ?>球</option>
							<?php $__FOR_START_27100__=0;$__FOR_END_27100__=7;for($j=$__FOR_START_27100__;$j < $__FOR_END_27100__;$j+=1){ if(($j) != "0"): ?><option value="<?php echo ($j); ?>" <?php if($opencodes[$i] == $j): ?>selected<?php endif; ?>><?php echo ($j); ?></option><?php endif; } ?>
						</select><?php } ?>
					</div><?php endif; ?>
					<!--低频彩-->
					<?php if(($typeid) == "dpc"): ?><div style="margin:0 auto;width:20em;">
						<?php $__FOR_START_8747__=0;$__FOR_END_8747__=3;for($i=$__FOR_START_8747__;$i < $__FOR_END_8747__;$i+=1){ ?><select id="opencode<?php echo ($i+1); ?>-<?php echo ($vo["expect"]); ?>" style="padding:2px 1px;width:auto;float:left;margin:1px 2px;">
							<option value="">第<?php echo ($i+1); ?>球</option>
							<?php $__FOR_START_32447__=0;$__FOR_END_32447__=10;for($j=$__FOR_START_32447__;$j < $__FOR_END_32447__;$j+=1){ ?><option value="<?php echo ($j); ?>" <?php if($opencodes[$i] == $j): ?>selected<?php endif; ?>><?php echo ($j); ?></option><?php } ?>
						</select><?php } ?>
					</div><?php endif; ?>
					<!--lhc-->
					<?php if(($typeid) == "lhc"): ?><div style="margin:0 auto;width:40em;">
						<?php $__FOR_START_2908__=0;$__FOR_END_2908__=7;for($i=$__FOR_START_2908__;$i < $__FOR_END_2908__;$i+=1){ ?><select id="opencode<?php echo ($i+1); ?>-<?php echo ($vo["expect"]); ?>" style="padding:2px 1px;width:50px;float:left;margin:1px 2px;">
							<option value="">第<?php echo ($i+1); ?>球</option>
							<?php $__FOR_START_29089__=0;$__FOR_END_29089__=50;for($j=$__FOR_START_29089__;$j < $__FOR_END_29089__;$j+=1){ if($j<10)$j='0'.$j?>
							<?php if(($j) != "0"): ?><option value="<?php echo ($j); ?>" <?php if($opencodes[$i] == $j): ?>selected<?php endif; ?>><?php echo ($j); ?></option><?php endif; } ?>
						</select><?php } ?>
					</div><?php endif; ?>
				</td>
