...
<div class="page-container">
	<div id="tab-system" class="HuiTab">
		<div class="tabBar cl">
			<span>快三</span><span>时时彩</span><span>飞艇/赛车</span><span>快乐8</span><span>11选5</span><span>3D/PL3</span><span>六合彩</span><a class="allshow" style="text-decoration: none;float: right">全部展开</a></div>
		<!--快3-->
		<div class="tabCon">
		...
		<div class="tabCon">
			<table class="table table-border table-bordered table-hover">
				...
				<tr>
					...
					<input class="input-text size-S input-change" style="width:80px;" id="playid-<?php echo ($item["playid"]); ?>" type="hidden" name="playid" value="<?php echo ($item["playid"]); ?>" defaultValue="<?php echo ($item["playid"]); ?>"></td>
					<?php if(isset($item['rate']) || isset($item['minrate']) || isset($item['maxrate'])){ ?>
