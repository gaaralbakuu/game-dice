...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal validate-form" id="AjaxPostForm">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">晋级奖励：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo ($info["jjje"]); ?>" placeholder="晋级奖励" name="jjje">
            </div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">跳级奖励：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo ($info["tiaoji"]); ?>" placeholder="跳级奖励" name="tiaoji">
            </div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">成长积分：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo ($info["shengjiedu"]); ?>" placeholder="成长积分" name="shengjiedu">
            </div>
        </div>
