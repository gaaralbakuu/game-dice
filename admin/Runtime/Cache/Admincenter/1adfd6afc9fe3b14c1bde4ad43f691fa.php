...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/"><?php echo GetVar('webtitle');?>管理系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="#">管理系统</a> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
...
<aside class="Hui-aside">
    ...
    <dd style="display:block">
        <ul>
            ...
            <li><a href="<?php echo U('Caipiao/yukaijiang');?>" data-title="预开奖">设置开奖</a></li>
...
<dl id="menu-article">
    <dt><i class="Hui-iconfont">&#xe62d;</i> 聊天室/动画管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
    <dd>
        <ul>
            <!-- <li><a href="<?php echo U('Admingroup/manage');?>" data-title="管理员组">管理员组</a></li> -->
            <li><a href="<?php echo U('Adminmember/chat');?>" data-title="聊天室/动画管理">聊天室/动画管理</a></li>
            <!-- <li><a href="<?php echo U('Adminmember/memlog');?>" data-title="管理员日志">管理员日志</a></li> -->
        </ul>
    </dd>
</dl>
