...
<script id="payisonline0" type="text/html">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input id="my_code" type="text" class="input-text" value="<?php echo ($configs["ewmurl"]); ?>" placeholder="二维码" name="configs[ewmurl]" id="ewmurl">
		</div>
	</div>
</script>
<script id="payisonline1" type="text/html">
    ...
    <eq name="info.paytype" value="tg_pay">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box">
                    <input name="configs[tgpay_type]" type="radio" value="0" <?php if($configs["tgpay_type"] == 0): ?>checked<?php endif; ?>>全部
                </div>
                <div class="radio-box">
                    <input name="configs[tgpay_type]" type="radio" value="1" <?php if($configs["tgpay_type"] == 1): ?>checked<?php endif; ?>>微信
                </div>
                <div class="radio-box">
                    <input name="configs[tgpay_type]" type="radio" value="2" <?php if($configs["tgpay_type"] == 2): ?>checked<?php endif; ?>>支付宝
                </div>
            </div>
        </div>
    </eq>
