...
class ssc{
    ...
    ** 五星单式
     * $opencode="1,2,3,9,8";
     * $tzcode="1,2,3,9,8|6,4,5,6,4|2,3,4,2,4|6,5,6,5,6|7,6,7,5,8|2,3,4,6,7|2,3,4,7,4";
    */
    ...
    ** 后四复式
     * $opencode="1,4,5,2,2";
    ** $tzcode="1,3,4,5|,4,5,6|,2,3,4,5|2,3|0,1,2";
    **
    */
	...
	protected function sxzuxzsq($opencode,$tzcode){
		...
		**/
		if(count($acs)==2 && $ball2 && $ball1 && in_array($ball2,$tzcodes) && in_array($ball1,$tzcodes)){
			$zjcount = count($tzcodes)*(count($tzcodes)-1);
		}
		return $zjcount;
	}
	/*
    ...
    ** 前三组六单式
     * $opencode="3,4,5,3,8";
    ** $tzcode="1,2,3|2,3,4|3,4,5|4,5,6|5,6,7|6,7,8|7,8,9|0,1,9";
    **
    */
    ...
    ** 前三混合组选
     * $opencode="1,1,2,3,8";
     * $tzcode="1,1,2|2,4,4|1,2,3|2,3,4";
    */
    ...
    ** 中三混合组选
     * $opencode="2,4,2,3,8";
     * $tzcode="1,2,3|2,3,4|3,4,5|4,5,6|5,6,7|6,7,8";
    */
    ...
    ** 中三组三单式
	 * $opencode="3,2,2,4,8";
    ** $tzcode="2,2,4|3,4,5|4,5,6|5,6,7";
    **
    */
    ...
    ** 后三组三单式
     * $opencode="1,2,4,3,3";
    ** $tzcode="1,1,2|2,2,3|3,3,4|4,4,6|5,5,7|4,4,8";
    **
    */
    ...
    ** 前二直选单式
     * $opencode="1,4,2,2,3";
     * $tzcode="1,4|2,2|3,3|4,4|5,5|2,3|3,4|4,5|5,6";
    */
    ...
    ** 后二直选单式
     * $opencode="1,4,2,2,3";
     * $tzcode="2,2|1,2|3,3|2,3|3,4|4,5|7,6|2,7|2,6";
    */
    ...
    ** 前二组选单式
     *  $opencode="1,2,2,2,3";
     * $tzcode="1,2|2,3|2,4|3,4|4,5|5,6";
    */
    ...
    ** 后二组选单式
     * $opencode="1,2,4,1,3";
     *  $tzcode="1,2|1,3|2,4|3,4|4,5|5,6";
    */
