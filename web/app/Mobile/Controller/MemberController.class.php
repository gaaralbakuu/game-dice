...
//		if($this->userinfo['modify'])$schedule += 15;
  ...
  //投注记录
	function betRecord()
	{
		...
		for($a = 0;$a<count($tzlist);$a++){
			switch ($tzlist[$a]['cpname']) {
					case 'f5k3':
					$tzlist[$a]['img'] = '/app/f5k3.png';
					# code...
					break;
					case 'f1k3':
					$tzlist[$a]['img'] = '/app/f1k3.png';
					# code...
					break;
					case 'jsk3':
					$tzlist[$a]['img'] = '/app/jsk3.png';
					# code...
					break;
					case 'bjk3':
					$tzlist[$a]['img'] = '/app/bjk3.png';
					# code...
					break;
					case 'gxk3':
					$tzlist[$a]['img'] = '/app/gxk3.png';
					# code...
					break;
					case 'ahk3':
					$tzlist[$a]['img'] = '/app/ahk3.png';
					# code...
					break;
					case 'bjpk10':
					$tzlist[$a]['img'] = '/app/bjpk10.png';
					# code...
					break;
					case 'xypk10':
					$tzlist[$a]['img'] = '/app/xypk10.png';
					# code...
					break;
					case 'dfpk10':
					$tzlist[$a]['img'] = '/app/dfpk10.png';
					# code...
					break;
					case 'lhc':
					$tzlist[$a]['img'] = '/app/lhc.png';
					# code...
					break;
					case 'dflhc':
					$tzlist[$a]['img'] = '/app/dflhc.png';
					# code...
					break;
					case 'jx11x5':
					$tzlist[$a]['img'] = '/app/jx11x5.png';
					# code...
					break;
					case 'df11x5':
					$tzlist[$a]['img'] = '/app/df11x5.png';
					# code...
					break;
					case 'xtxssc':
					$tzlist[$a]['img'] = '/app/xtxssc.png';
					# code...
					break;
					case 'oldssc':
					$tzlist[$a]['img'] = '/app/oldssc.png';
					# code...
					break;
					case 'jlk3':
					$tzlist[$a]['img'] = '/app/jlk3.png';
					# code...
					break;
					case 'cqssc':
					$tzlist[$a]['img'] = '/app/cqssc.png';
					# code...
					break;
					case 'xjssc':
					$tzlist[$a]['img'] = '/app/xjssc.png';
					# code...
					break;
					case 'tjssc':
					$tzlist[$a]['img'] = '/app/tjssc.png';
					# code...
					break;
					case 'gd11x5':
					$tzlist[$a]['img'] = '/app/gd11x5.png';
					# code...
					break;
					case 'sh11x5':
					$tzlist[$a]['img'] = '/app/sh11x5.png';
					# code...
					break;
					case 'df3d':
					$tzlist[$a]['img'] = '/app/df3d.png';
					# code...
					break;
					case 'fc3d':
					$tzlist[$a]['img'] = '/app/fc3d.png';
					# code...
					break;
					case 'wfssc':
					$tzlist[$a]['img'] = '/app/wfssc.png';
					# code...
					break;
					case 'efssc':
					$tzlist[$a]['img'] = '/app/efssc.png';
					# code...
					break;
					case 'yfssc':
					$tzlist[$a]['img'] = '/app/yfssc.png';
					# code...
					break;
					case 'hebk3':
					$tzlist[$a]['img'] = '/app/hebk3.png';
					# code...
					break;
					case 'dfkeno':
					$tzlist[$a]['img'] = '/app/dfkeno.png';
					# code...
					break;
					case 'hubk3':
					$tzlist[$a]['img'] = '/app/hubk3.png';
					# code...
					break;
	...
	//投注记录
	function betRecordDetails()
	{
		/*	$this->name      =*/ 
		$trano      = I('trano');
		
		//全部彩种
		$tzlist = M('touzhu')->where("trano='".$trano."'")->find();


		$tzlist['oddtime'] = date('Y-m-d H:i:s',$tzlist['oddtime']);
		$a = 0;
			switch ($tzlist['cpname']) {
					case 'f5k3':
					$tzlist['img'] = '/app/f5k3.png';
					# code...
					break;
					case 'f1k3':
					$tzlist['img'] = '/app/f1k3.png';
					# code...
					break;
					case 'jsk3':
					$tzlist['img'] = '/app/jsk3.png';
					# code...
					break;
					case 'bjk3':
					$tzlist['img'] = '/app/bjk3.png';
					# code...
					break;
					case 'gxk3':
					$tzlist['img'] = '/app/gxk3.png';
					# code...
					break;
					case 'ahk3':
					$tzlist['img'] = '/app/ahk3.png';
					# code...
					break;
					case 'bjpk10':
					$tzlist['img'] = '/app/bjpk10.png';
					# code...
					break;
					case 'xypk10':
					$tzlist['img'] = '/app/xypk10.png';
					# code...
					break;
					case 'dfpk10':
					$tzlist['img'] = '/app/dfpk10.png';
					# code...
					break;
					case 'lhc':
					$tzlist['img'] = '/app/lhc.png';
					# code...
					break;
					case 'dflhc':
					$tzlist['img'] = '/app/dflhc.png';
					# code...
					break;
					case 'jx11x5':
					$tzlist['img'] = '/app/jx11x5.png';
					# code...
					break;
					case 'df11x5':
					$tzlist['img'] = '/app/df11x5.png';
					# code...
					break;
					case 'xtxssc':
					$tzlist['img'] = '/app/xtxssc.png';
					# code...
					break;
					case 'oldssc':
					$tzlist['img'] = '/app/oldssc.png';
					# code...
					break;
					case 'jlk3':
					$tzlist['img'] = '/app/jlk3.png';
					# code...
					break;
					case 'cqssc':
					$tzlist['img'] = '/app/cqssc.png';
					# code...
					break;
					case 'xjssc':
					$tzlist['img'] = '/app/xjssc.png';
					# code...
					break;
					case 'tjssc':
					$tzlist['img'] = '/app/tjssc.png';
					# code...
					break;
					case 'gd11x5':
					$tzlist['img'] = '/app/gd11x5.png';
					# code...
					break;
					case 'sh11x5':
					$tzlist['img'] = '/app/sh11x5.png';
					# code...
					break;
					case 'df3d':
					$tzlist['img'] = '/app/df3d.png';
					# code...
					break;
					case 'fc3d':
					$tzlist['img'] = '/app/fc3d.png';
					# code...
					break;
					case 'wfssc':
					$tzlist['img'] = '/app/wfssc.png';
					# code...
					break;
					case 'efssc':
					$tzlist['img'] = '/app/efssc.png';
					# code...
					break;
					case 'yfssc':
					$tzlist['img'] = '/app/yfssc.png';
					# code...
					break;
					case 'hebk3':
					$tzlist['img'] = '/app/hebk3.png';
					# code...
					break;
					case 'dfkeno':
					$tzlist['img'] = '/app/dfkeno.png';
					break;
					case 'hubk3':
					$tzlist['img'] = '/app/hubk3.png';
					# code...
					break;
		...
		$this->assign('my_touzhud',$tzlist);
		// file_put_contents("ttt.txt", $touzhudetails);
		$this->display();
	}
	//修改安全密码
	function update_safepass()
	{
		$uinfo = M('member')->where("id=".$this->userinfo['id'])->field('password,tradepassword,username,mzijin_num')->find();
		if(IS_POST)
		{
			if(I('post.settype')==1)
			{
			...
			if($uinfo['mzijin_num']=='0'){
				$test = M('member')->where("username='".$uinfo['username']."'")->setField(array('mzijin_num'=>'1'));
				$this->error('原安全密码错误，您还有3次机会');
			}else if($uinfo['mzijin_num']=='1'){
				M('member')->where("username='".$uinfo['username']."'")->setField(array('mzijin_num'=>'2'));
				$this->error('原安全密码错误，您还有2次机会');
			}else if($uinfo['mzijin_num']=='2'){
				M('member')->where("username='".$uinfo['username']."'")->setField(array('mzijin_num'=>'3'));
				$this->error('原安全密码错误，您还有1次机会');
			}else if($uinfo['mzijin_num']=='3'){
				$this->error('修改功能已锁定，请联系客服重置！');
			}
				} else {
					M('member')->where("username='".$uinfo['username']."'")->setField(array('mzijin_num'=>'0'));
