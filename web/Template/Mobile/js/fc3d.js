	...
	$node.html('');
	  $.post(url, {'lotteryname':lotteryname}, function(data) {
        ...
        var yopentime = yopentimes_arr[1];
				html += '<tr><td style="border-right: 1px solid #DCDFE6;">'+openinfo.expect+'</td><td class="c_red fb" style="padding:5px;color:red;">'+openinfo.opencode+'</td><td class="c_blue fb" style="padding:5px;">'+yopentime+'</td></tr>';
            ...
            if (msg.sign == true) {
                if (msg.data.opencode.length > 0) {
                    ...
                    if (lastExpect == openexpect) {
                        ...
                        var yopentimes_arr = yopentimes.split(' ');
                        var yopentime = yopentimes_arr[1];
                        var html = '<tr><td class="lsqh" style="border-right: 1px solid #DCDFE6;">' + openexpect + '</td><td style="padding:5px;color:red;" class="c_red fb';
                        html += '">';
