...
var lotteryopencodes = function(lotteryname){
	...
	$.post(url, {'lotteryname':lotteryname}, function(data) {
        ...
        var yopentime = yopentimes_arr[1];
         arr = openinfo.opencode.split(',');
          strspan = "";
				for(var a in arr){
					strspan+="<span>"+arr[a]+"</span>";
				}
				html += '<tr><td width="" style="border-right: 1px solid #DCDFE6;">'+openinfo.expect+'<br>'+yopentime+'</td><td class="on" width="" class="c_red fb" style="padding:5px;color:red;">'+strspan+'</td></tr>';
	 ...
	 $.ajax({  
         ...
         success:function(msg){ 
            if (msg.sign == true) {
				...
				html="";
				html += '<tr><td width="" style="border-right: 1px solid #DCDFE6;">'+openexpect+'<br>'+yopentime+'</td><td class="on" width="" class="c_red fb" style="padding:5px;color:red;">'+strspan+'</td></tr>';
