	...
	<div class="promotion_btn" style="font-size: 18px;margin-bottom: 20px;border-bottom:0;border-radius: 2px;overflow: hidden;">
		<notempty name="Think.session.userinfo">
			<eq name="jlje" value="0">
				<strong><a href="javascript:void(0);" class="btn no_login_btn" style="font-size: 18px;">无奖励</a></strong>
				<else />
				<strong style="background-color: #67C23A;"><a style="color: white;font-size: 18px;" href="javascript:void(0);" class="btn btn-danger" onclick="jiangli();" >点击领取奖励</a></strong>
			</eq>
			<else />
