...
<section class="" id="gamepage">
    ...
    function mian_video(){
        var type = getQueryString('code');
            ...
            var str = '<div class="parent_chile"><iframe id="child" src="https://kj.kai861.com/view/video/PK10/video.html?10001?1682010.co" width="100%" scrolling="no" height="100%" frameborder="0"></iframe><img src="__ROOT__/resources/images/arraw_left.png" class="close_video_button" onclick="close_video()" /></div>';
                $('#video_box').append(str);
            }else if(type == 'dfpk10'){
                $('.mobile_video').css("display","block");
                var str = '<div class="parent_chile"><iframe id="child" src="https://kj.kai861.com/view/video/jisuft_video/index.html?10057?1682010.co" width="100%" scrolling="no" height="100%" frameborder="0"></iframe><img src="__ROOT__/resources/images/arraw_left.png" class="close_video_button" onclick="close_video()" /></div>';
                $('#video_box').append(str);
            }
        }
    }
        ...
        <header data-am-widget="header" class="am-header am-header-default header nav_bg am-header-fixed"
            ...
            <ul class="yGame_list">
                <volist name="ssclist" id="vo">
                    <li class="<if condition=" $vo[
                    'name'] eq $lotteryname">curr</if> am-modal-actions-header" lotteryname="{$vo.name}">
