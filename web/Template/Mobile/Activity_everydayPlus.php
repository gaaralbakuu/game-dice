...
<body class="bg_fff">
	...
	<notempty name="Think.session.userinfo">
		...
		<eq name="jiajiang" value="">
			<strong><a href="javascript:void(0);" class="btn no_login_btn" style="font-size: 18px;">无加奖</a></strong>
			<else />
			<strong><a href="javascript:void(0);" class="btn btn-danger" onclick="qingquyongqu();" style="font-size: 18px;color: white;">点击领取加奖</a></strong>
		</eq>
			<else />
			<strong><a href="javascript:void(0);" class="btn no_login_btn" style="font-size: 18px;">无加奖</a></strong>
			</if>
