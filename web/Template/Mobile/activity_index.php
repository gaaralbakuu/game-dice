...
<body style="background:#F0F0F0">
	<header data-am-widget="header"class="am-header am-header-default header nav_bg am-header-fixed">
		<h3 class="am-header-title activity_h3">
			活动中心
		</h3>
	</header>
	...
	<div class="activity_list">
		<a href="{:U('Activity/s4')}?id=5" class="am-cf am-block">
	...
	<div class="activity_list">
		<a href="{:U('Activity/s3')}?id=6" class="am-cf am-block">
	...
	<div class="activity_list">
		<a href="{:U('Activity/s5')}?id=7" class="am-cf am-block">
