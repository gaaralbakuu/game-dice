...
<body class="bg_fff">
	...
	<div data-am-widget="" class="am-tabs am-tabs-d2 billrecord_main">
		<ul class="am-tabs-nav am-cf am-avg-sm-3" style="text-align:center;">
			...
			<li class="am-active"><a href="{:U('Mobile/Account/dealRecord2')}">充值记录</a></li>
...
//			var type = $('#type').val();
			var atime = t;
			var url = "__ROOT__/?m=Mobile&c=Account&a=dealRecord2&atime="+atime/*+"&type="+type*/;
