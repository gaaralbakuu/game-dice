    ...
    <div class="mobileGameTop">
        ...
        <div class="play_select_insert" id="j_play_select">
            <ul class="play_select_tit" style="overflow:hidden;">
                ...
                <li lottery_code="lh">龙虎斗</li>
                <li lottery_code="xyp">信用盘</li>
            </ul>
            <!--玩法二级选项开始-->
    ...
    <div class="open_containers g_Time_Section">
        ...
        <div class="cz_openNumb">
            ...
            <div class="open_issue" id="showTabel"><span class="c_red" way-data="showExpect.lastFullExpect"
                ...
                </span>期开奖号码<i class="iconfont icon-jiantouxia"></i>
            </div>
                        ...
                        <div class="lottery_footer">
                            <div class="betting-button clearfix">
                                <div class="betting_left">
                                    <input type="tel" class="rate_input" onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))">元
                                </div>
