	...
	<div id="pay_alipay" class="me-infor" style="display:none;padding: 15px;background: #fff;margin-bottom:10px;">
			<div class="infor-xx">
					<ul class="mar-lr20">
						...
						<li>
							<strong>商户订单号：</strong>
							<span><em class="mark" id="saomabill_amount" way-data="saomabill.amount"></em><?php echo $_GET["oid"]; ?>元</span>
						</li>
						<li>
							<strong>商品名称：</strong>
							<span way-data="saomabill.trano" id="saomabill_trano" class="mark"><?php echo $_GET["oname"]; ?></span>
						</li>
						<li>
							<strong>附言码：</strong>
							<span way-data="saomabill.id" id="saomabill_id" class="mark"></span>
						</li>
						<li class='payerweima text-center'></li>
						<li class='payerweima' style='height:auto'><span><img src="{$Allmsg['ewmurl']}" style='width:250px;border:none;display:block; margin:0 auto;'></span></li>
					</ul>
				</div>
				...
				<li class="am-cf">
					...
					<div class="am-fr bank_right_input">
						...
						<svg class="icon" aria-hidden="true" style="width: 2em;height: 2em;margin-top: 7px;">
								<use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-tian"></use>
						</svg>
					</div>
				</li>
			</ul>
