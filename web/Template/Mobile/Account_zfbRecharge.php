...
<body>
	...
	<div id="pay_alipay" class="me-infor" style="display:none;padding: 15px;background: #fff;margin-bottom:10px;">
			<div class="infor-xx">
				...
				<a class="btn common_btn" style=" width: 7em;display: block;margin: 1em auto;background: #dd514c;text-align: center;border-radius: 4px;color: #fff;" href="javascript:;"  onclick="alt('充值成功申请已提交')">提交</a>
	</div>
