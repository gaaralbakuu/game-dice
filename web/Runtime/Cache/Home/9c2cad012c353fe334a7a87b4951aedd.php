...
<script type="text/javascript" src="/resources/main/kl8.js"></script>
<script type="text/javascript" src="/resources/js2/kl8tabGame.js"></script>
        ...
        <div class="gameBet_right" style="margin-top: -35px;">
            ...
            <div class="right_infsoBlock">
                <div class="title">
                    ...
                    <span class="fr">
                    <a target="_blank" class="open_lotteryNumb_chart yopen_explain"  href="<?php echo U('Trend/trend_keno',array('code'=>$nowcpinfo['name']));?>">走势图</a>
                    |
...
mian_video();
     function mian_video(){
        var type = $('.lottery_title_h2').html();
            ...
            var str = '<div class="parent_chile"><iframe id="child" src="https://kj.kai861.com/view/video/bjkl8Video/index.html?10014?1682010.co" width="100%" scrolling="no" height="100%" frameborder="0"></iframe><img src="/resources/images/arraw_left.png" class="close_video_button" onclick="close_video()" /></div>';
