...
<div class="login_main">
	<div class="login_bg">
		<div class="login_title" style="padding-bottom: 10px;">
			<h2 class="margin_0">用户登录</h2>
		</div>
		<div class="login_input">
			<form method="post" class="ruivalidate_form_class" onsubmit="return check_login(this)" id="ruivalidate_form_class" checkby_ruivalidate url="" action="<?php echo U('Public/logindo');?>">
...
<!--				<div class="login_pass user_commom_style">
				...
				<div class="btn_submit">
					<input  type="submit" value="点击登录" class="btn-danger active sub_btn btn-sm" style="width:8em;height:2em;font-size: 1.3em;background-color: #f72222;border-color: #f72222;"/>
