...
<script type="text/javascript" src="/resources/main/syxw.js"></script>
<script type="text/javascript" src="/resources/js2/syxwtabGame.js"></script>
...
<div id="video_box" style="width: 100vw; height: 100vh; background-color: rgba(0,0,0,0.8);">
    ...
    <span id="chattext" onclick="chatswitch()">隐<br>藏<br>聊<br>天<br>室</span>
     <div class="chatbar">
    <!---->
                ...
                <div class="compose">
                    ...
                    <div class="typing">
                        <div class="txtinput el-textarea {if $info['is_temporary']==1}is-disabled{/if}">
                            <textarea  id="textarea_content" {if $info['is_temporary']==1}disabled   {/if} type="textarea" autosize="[object Object]" rows="2" autocomplete="off" validateevent="true" class="el-textarea__inner" style="height: 54px;"></textarea>
                        </div>
...
<!--                <i class="icon-11xuan5 iconfont common_lottery_icon" style="color:#218ddd;"></i>-->
	...
	function mian_video(){
		var type = $('.lottery_title_h2').html();
			...
			var str = '<div class="parent_chile"><iframe id="child" src="https://kj.kai861.com/view/video/11x5_video/index.html?10006?1682010.co" width="100%" scrolling="no" height="100%" frameborder="0"></iframe><img src="/resources/images/arraw_left.png" class="close_video_button" onclick="close_video()" /></div>';
				$('#video_box').append(str);
			}else if(type == '上海11选5'){
				$('.start_video').css("display","block");
				var str = '<div class="parent_chile"><iframe id="child" src="https://kj.kai861.com/view/video/11x5_video/index.html?10018?1682010.co" width="100%" scrolling="no" height="100%" frameborder="0"></iframe><img src="/resources/images/arraw_left.png" class="close_video_button" onclick="close_video()" /></div>';
				$('#video_box').append(str);
			}else if(type == '江西11选5'){
				$('.start_video').css("display","block");
				var str = '<div class="parent_chile"><iframe id="child" src="https://kj.kai861.com/view/video/11x5_video/index.html?10015?1682010.co" width="100%" scrolling="no" height="100%" frameborder="0"></iframe><img src="/resources/images/arraw_left.png" class="close_video_button" onclick="close_video()" /></div>';
				$('#video_box').append(str);
			}
        }
	}
		...
		<div class="system_lottery_box">
			...
			<ul class="system_lottery" style="width: 1506px;">
				...
				<?php if(is_array($ssclist)): $i = 0; $__LIST__ = $ssclist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if($vo['name'] == $lotteryname): ?>class="curr"<?php endif; ?> lotteryname="<?php echo ($vo["name"]); ?>">
						<a href="/Game.x5?code=<?php echo ($vo["name"]); ?>"><?php echo ($vo["title"]); ?></a>
        ...
        <div class="gameBet_right">
            ...
            <div class="right_infsoBlock">
                <div class="title">
                    ...
                    <span class="fr">
                    <a target="_blank" class="open_lotteryNumb_chart yopen_explain"  href="<?php echo U('Trend/trend_x5',array('code'=>$nowcpinfo['name']));?>">走势图</a>
                    |
