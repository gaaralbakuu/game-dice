<?php if (!defined('THINK_PATH')) exit();?><link rel="stylesheet" href="/resources/css2/bootstrap.min.css">
...
<link rel="stylesheet" type="text/css" href="/resources/css/style.css" />
    ...
    <div class="wapper ">
        <div class="w1000">
    		...
    		<div class="f_cont">
    			<form action="<?php echo U('Public/forgetPaw');?>" method="post" id="form1">
	  ...
	  <!--                  <td>
	                    	...
	                    	<img  src="<?php echo U('Public/verify',array('imageW'=>110,'imageH'=>40,'fontSize'=>15));?>"  onclick="this.src=this.src+'?temp='+ 1" />
	                    <span class="Validform_checktip"></span></td>-->
	                    </tr>
	                    <tr>
	                    <th scope="row">&nbsp;</th>
