...
<head>
	...
	<link rel="stylesheet" href="/resources/css2/updatePass.css">
...
<script src="/resources/js2/require.js" data-main="/resources/js2/homePage"></script>
	...
	<div class="container-fluid">
		...
		<form action="<?php echo U('Member/safephone');?>" class="update_form" method="post">
			<p>
				<span>手机号：</span>
				<input type="text" name="tel" value="<?php echo ($userinfo["tel"]); ?>"> 绑定后修改需联系客服!
			</p>
			<!--<p>
				<span>验证码：</span>
