...
<script type="text/javascript" src="/resources/main/lhc.js"></script>
<script type="text/javascript" src="/resources/js2/lhctabGame.js"></script>
                ...
                <div class="compose">
                    ...
                    <div class="typing">
                        <div class="txtinput el-textarea {if $info['is_temporary']==1}is-disabled{/if}">
                            <textarea  id="textarea_content" {if $info['is_temporary']==1}disabled  {/if} type="textarea" autosize="[object Object]" rows="2" placeholder="请输入" autocomplete="off" validateevent="true" class="el-textarea__inner" style="height: 54px;"></textarea>
                        </div>
		...
		<div class="system_lottery_box">
			...
			<ul class="system_lottery" style="width: 1506px;">
				...
				<?php if(is_array($ssclist)): $i = 0; $__LIST__ = $ssclist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if($vo['name'] == $lotteryname): ?>class="curr"<?php endif; ?> lotteryname="<?php echo ($vo["name"]); ?>">
						<a href="/Game.lhc?code=<?php echo ($vo["name"]); ?>"><?php echo ($vo["title"]); ?></a>
        ...
        <div class="gameBet_right">
            ...
            <div class="right_infsoBlock">
                <div class="title">
                    ...
                    <span class="fr">
                    <a target="_blank" class="open_lotteryNumb_chart yopen_explain"  href="<?php echo U('Trend/trend_lhc',array('code'=>$nowcpinfo['name']));?>">走势图</a>
                    |
