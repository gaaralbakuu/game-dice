...
<script type="text/javascript" src="/resources/main/ssc.js"></script>
<script type="text/javascript" src="/resources/js2/tabGame.js"></script>
<script type="text/javascript" src="/resources/js2/bootstrap.min.js"></script>
<script type="text/javascript" src="/resources/js/k3_tz.js"></script>
...
<!--                <i class="icon--shishicai iconfont special common_lottery_icon"></i>-->
    ...
    function mian_video(){
        var type = $('.lottery_title_h2').html();
            ...
            var str = '<div class="parent_chile"><iframe id="child" src="https://kj.kai861.com/view/video/SSC/index.html?10060?1682010.co" width="100%" scrolling="no" height="100%" frameborder="0"></iframe><img src="/resources/images/arraw_left.png" class="close_video_button" onclick="close_video()" /></div>';
                $('#video_box').append(str);
            }else if(type == '新疆时时彩'){
                $('.start_video').css("display","block");
                var str = '<div class="parent_chile"><iframe id="child" src="https://kj.kai861.com/view/video/SSC/index.html?10004?1682010.co" width="100%" scrolling="no" height="100%" frameborder="0"></iframe><img src="/resources/images/arraw_left.png" class="close_video_button" onclick="close_video()" /></div>';
                $('#video_box').append(str);
            }else if(type == '天津时时彩'){
                $('.start_video').css("display","block");
                var str = '<div class="parent_chile"><iframe id="child" src="https://kj.kai861.com/view/video/SSC/index.html?10003?1682010.co" width="100%" scrolling="no" height="100%" frameborder="0"></iframe><img src="/resources/images/arraw_left.png" class="close_video_button" onclick="close_video()" /></div>';
                $('#video_box').append(str);
            }
        }
    }
		...
		<div class="system_lottery_box">
			...
			<ul class="system_lottery" style="width: 1506px;">
				...
				<?php if(is_array($ssclist)): $i = 0; $__LIST__ = $ssclist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if($vo['name'] == $lotteryname): ?>class="curr"<?php endif; ?> lotteryname="<?php echo ($vo["name"]); ?>">
						<a href="/Game.ssc?code=<?php echo ($vo["name"]); ?>"><?php echo ($vo["title"]); ?></a>
		...
		<section class="gameBet_balls">
			...
			<?php if($nowcpinfo['iswh'] == 0): ?><!--玩法二级选项开始-->
				...
				<div class="play_select_prompt" style="padding:10px 0;">
					...
					<span way-data="tabDoc">玩法说明</span>
				</div>
				<div class="g_Number_Section" style="width: 720px;padding: 15px 0;">
                    <div class="g_Number_Main">

                    </div>
				</div>
                <!-- test start -->

                <div id="detail_order" class="clearfix" style="display: none;">
                    <div class="pull-right">
                        <label class="col-xs-1 control-label">金额</label>
                        <div class="input-group">
                            <span class="input-group-addon">¥</span>
                            <input type="text" id="detail_money" class="form-control">
                        ...
                        <span class="chips">
                            ...
                            <i class="chips-100"></i>
                            <i class="chips-500"></i>
                            <i class="chips-1000"></i>
                            <i class="chips-5000"></i>
                            <i class="chips-10000"></i>
                        </span>
                        <a id="order_btn" href="javascript:;" class="btn btn-primary">下注</a>
                        <a id="reset_btn" href="javascript:;" class="btn btn-danger">重置</a>
                    </div>
				...
				<div class="addtobet">
                    ...
                    <button class="randomBtn random1" type="button">机选1注</button>
                    <button class="randomBtn random5" type="button">机选5注</button>
				</div>
				<div class="xiad-left">
        ...
        <div class="gameBet_right">
            ...
            <div class="right_infsoBlock">
                <div class="title">
                    ...
                    <span class="fr">
                    <a target="_blank" class="open_lotteryNumb_chart yopen_explain"  href="<?php echo U('Trend/trend_ssc',array('code'=>$nowcpinfo['name']));?>">走势图</a>
                    |
