                                            ...
                                            <div class="dzxz">
                                                <ul>
                                                    <li><input type="radio" id="cz" value="cz" placeholder=""
                                                               name="indexType" checked="checked"><label for="cz" class="checked">充值</label>
                                                    </li>
                                    ...
                                    <div class="m-a-n-bd tabBd">
                                        <div class="tb-imte cur" style="display: block;">
                                            <div class="m-warm-prompt">
                                                ...
                                                <p>3. 固定推广链接：<span class="mark">http://<?php echo ($_SERVER['HTTP_HOST']); ?>/Public.register.tgid.<way
                                    ...
                                    <tr>
                                        <th colspan="8">
                                            ...
                                            <select id="sourceModule">
                                                ...
                                                <?php if(is_array($fuddetailtypes)): foreach($fuddetailtypes as $fk=>$ft): ?><option value="<?php echo ($fk); ?>" {if condition="$fk eq $type" }selected{
                                                    /if}><?php echo ($ft); ?></option><?php endforeach; endif; ?>
                                            </select>
                                            <a href="javascript:;" class="in-but-l h-32"
