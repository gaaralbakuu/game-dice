...
<link rel="stylesheet" type="text/css" href="/resources/css/style.css" />
    ...
    <div class="wapper ">
    		...
    		<div class="f_cont">
    			...
    			<form action="<?php echo U('Public/forgetPaw1');?>" method="post" id="form1">
	                ...
	                <table class="table_code" width="100%" cellspacing="0" cellpadding="0" border="0">
	                    ...
	                    <th scope="row">&nbsp;</th>
	                    <td>
	                    	<input class="ty_btn" value="上一步" type="button" onclick="window.location.href='<?php echo U('Public/forgetPaw');?>';">
