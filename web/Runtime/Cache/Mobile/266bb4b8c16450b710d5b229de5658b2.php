...
<head>
    ...
    <meta name="viewport"
          content="width=device-width, initial-scale=1,minimum-scale=1,maximum-scale=1,user-scalable=none">
...
<script type="text/javascript" src="/Template/Mobile/js/pk10.js"></script>
<script type="text/javascript" src="/Template/Mobile/js/pk10tabGame.js"></script>
...
<section class="" id="gamepage">
    <span onclick="strat_video()" class="start_video mobile_video">
        动画
    </span>
    ...
    <script type="text/javascript">
        ...
        function close_video(){
         ...
         function strat_chat(){
            $("#chat_box").animate({left:'0px'},800);
        }
        function close_chat(){
            $("#chat_box").animate({left:'-100vw'},700);
        }
    ...
    function mian_video(){
        var type = getQueryString('code');

             if($('#is_video').html() == '1'){
            if(type == 'bjpk10'){
            
                $('.mobile_video').css("display","block");
            var str = '<div class="parent_chile"><iframe id="child" src="https://kj.kai861.com/view/video/PK10/video.html?10001?1682010.co" width="100%" scrolling="no" height="100%" frameborder="0"></iframe><img src="/resources/images/arraw_left.png" class="close_video_button" onclick="close_video()" /></div>';
                $('#video_box').append(str);
            }else if(type == 'dfpk10'){
                $('.mobile_video').css("display","block");
                var str = '<div class="parent_chile"><iframe id="child" src="https://kj.kai861.com/view/video/jisuft_video/index.html?10057?1682010.co" width="100%" scrolling="no" height="100%" frameborder="0"></iframe><img src="/resources/images/arraw_left.png" class="close_video_button" onclick="close_video()" /></div>';
                $('#video_box').append(str);
            }
        }
    }
...
return null;
    ...
    <div class="mobileGameTop">
        <header data-am-widget="header" class="am-header am-header-default header nav_bg am-header-fixed"
            ...
            <h1 class="am-header-title userHome_h1" style="height: 50px; margin: 0 auto; width: 100%;">
            ...
            <ul class="yGame_list">
                <?php if(is_array($ssclist)): $i = 0; $__LIST__ = $ssclist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="<?php if( $vo[ 'name'] == $lotteryname): ?>curr<?php endif; ?> am-modal-actions-header" lotteryname="<?php echo ($vo["name"]); ?>">
                    <a href="/Game.pk10?code=<?php echo ($vo["name"]); ?>" style="padding: 0;"><?php echo ($vo["title"]); ?></a>
        ...
        <div class="play_select_insert" id="j_play_select">
            <ul class="play_select_tit" style="overflow:hidden;">
                ...
                <li lottery_code="xyp" class="curr">
                    信用盘
                    <em class="newPlayType"></em>
                </li>
    ...
    <div class="open_containers g_Time_Section">
        <!--彩种开奖倒计时-->
        <!--彩种开奖倒计时-->
        <div class="cz_daojishi" style="width: 35%;height: 70px;">
            <div class="open_issue">
				<span class="c_red" id="f_lottery_info_number" way-data="showExpect.currFullExpect" ></span>截止
			</div>
        ...
        <div class="cz_openNumb">
            ...
            <div class="block_container lishi">
                ...
                <table id="fn_getoPenGame" border="0px" cellpadding="0" cellspacing="0">
                    ...
                    <tbody class="tbody text-c my_line">
                    <!--开奖期号-->
                    <!--开奖号码-->
                    <!--和值-->
                    <!--大小-->
                ...
                <span onclick="" id="cz_daojishi1" class="my_close_lishi" style="z-index: 10000000;">关闭</span>
                </div>
                </div>
        </div>
        <!--彩种开奖号码-->
        <i onclick="" class="iconfont icon-jiantouxia my_jiantouxia cz_daojishi2"></i>
    </div>
            ...
            <section class="gameBet_balls">
                <div class="gameBet_left l">
                    <?php if($nowcpinfo['iswh'] == 0): ?><!--玩法详细说明区域-->
                        <div class="play_select_prompt" style="display: none;">
                        ...
                        <div class="lottery_footer">
                            <div class="betting-button clearfix">
                                <div class="betting_left">
                                    <input id="my_input_money" type="tel" class="rate_input"
                                           onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))" placeholder="金额"> 元
                                </div>
                                <div style="margin-left: 2px; display: inline-block; font-size: 0px;">
    <span onclick="change_money(10)" class="a10">10</span>
    <span onclick="change_money(50)" class="a50">50</span>
    <span onclick="change_money(100)" class="a100">100</span>
    <span onclick="change_money(500)" class="a500">500</span>
    <span onclick="change_money(1000)" class="a1k">1k</span>
    <span onclick="change_money(0)" class="all">梭哈</span>
    <script type="text/javascript">
        function change_money(v){
            if(v==0){
                document.getElementById('my_input_money').value = document.getElementById("money_text").innerHTML;
            }else{
                document.getElementById('my_input_money').value = v;
            }
        }
        function clear_data(){
            document.getElementById('my_input_money').value = "";
        }
    </script>

    </div>
                                <div class="betting_right">
                                    <button onclick="clear_data()" class="betting_empty">清空</button>
                                    <button class="betting_right_btn">确定</button>
                                    <!-- "#f_submit_order" -->
                                </div>
                            </div>
                        </div>
              ...
              元
                        ...
                        <div class="numberLan" style="display: none;">
                            <header data-am-widget="header"
                                    class="am-header am-header-default header nav_bg am-header-fixed am-no-layout">
                                <div class="am-header-left am-header-nav">
                                ...
                                <h1 class="am-header-title userHome_h1"
                                    style="margin: 0 auto; width: 100%;font-size: 20px;">
                                    号码篮
                                </h1>
                            </header>
            ...
            <span class="selectMultipleOld">
              <div class="g_Chase_Section">
								<div class="chase_Program">
									<p class="p_chase">方案
										<i class="c_green fw_600" way-data="ytotal_money_zhushu"
                                           id="f_gameOrder_lotterys_num">0</i>注，
...
<div id="getBillInfobox" style="display:none">
    <div class="submitComfire">
        <ul class="ui-form">
            <li style="width:50%; float:left"><label for="question1" class="ui-label">彩种：</label><span class="mark"
                                                                                                       way-data="BillInfo.cptitle">--</span>
            </li>
            <li style="width:50%; float:left"><label for="question1" class="ui-label">期号：</label><span
                        class="mark">第 <span way-data="BillInfo.expect" class="mark">--</span> 期</span></li>
            <li style="width:50%; float:left"><label for="question1" class="ui-label">玩法：</label><span class="mark"
                                                                                                       way-data="BillInfo.playtitle">--</span>
            </li>
            <li style="width:50%; float:left"><label for="question1" class="ui-label">赔率：</label><span
                        way-data="BillInfo.mode" class="mark">--</span></li>
            <li><label for="answer1" class="ui-label">投注号码：</label><span class="mark"
                                                                         way-data="BillInfo.tzcode">--</span></li>
            <li style="width:50%; float:left"><label for="question2" class="ui-label">单注金额：</label><span class="mark"
                                                                                                         way-data="BillInfo.amount">--</span>
            </li>
            <li style="width:50%; float:left"><label for="question2" class="ui-label">投注注数：</label><span class="mark"
                                                                                                         way-data="BillInfo.itemcount">--</span>
            </li>
            <li style="width:50%; float:left"><label for="question2" class="ui-label">中奖金额：</label><span class="mark"
                                                                                                         way-data="BillInfo.okamount">--</span>
            </li>
            <li style="width:50%; float:left"><label for="question2" class="ui-label">中奖注数：</label><span class="mark"
                                                                                                         way-data="BillInfo.okcount">--</span>
            </li>


            <li style="width:50%; float:left"><label for="question2" class="ui-label">开奖号码：</label><span class="mark"
                                                                                                         way-data="BillInfo.opencode">--</span>
            </li>
            <li style="width:50%; float:left"><label for="question2" class="ui-label">中奖状态：</label><span
                        id="BillInfo_isdraw" way-data="BillInfo.state">--</span></li>
        </ul>
    </div>
</div>
...
<script>
    ...
    $(document).on('click', '.cz_daojishi2', function () {
        if ($('.lishi').is(':hidden')) {
            $('.lishi').show();
        } else {
            $('.lishi').hide();
    ...
    $(document).on('click', '#cz_daojishi1', function () {
        if ($('.lishi').is(':hidden')) {
            $('.lishi').show();
        } else {
            $('.lishi').hide();
...
<div class="ymask"
     style="width: 100%;height: 100%;position:fixed;top:0;left:0;background: rgba(0,0,0,0.3);display:none;"></div>
