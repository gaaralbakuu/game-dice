...
<header data-am-widget="header"class="am-header am-header-default header nav_bg am-header-fixed">
    ...
    <h1 class="am-header-title userHome_h1" style="margin: 0 auto; width: 100%;">
        用户登录
        <span><a href="<?php echo GetVar('kefuthree');?>" style="padding-right: 10px; position: absolute;right: 0px;top: 0px;color: white;font-size: 14px;">
    ...
    <div class="am-container" style="margin-top: 70px;">
        <div class="am-g" style="text-align: center;"> 
            <img src="/Template/Mobile/images/index/logo-3.png" alt="" style="width: 60px;margin: 0 auto;display: block;">
...
<div class="bank_recharge">
    <form method="post" class="ruivalidate_form_class" onSubmit="return check_login(this)" id="form1" checkby_ruivalidate url="" action="<?php echo U('Public/logindo');?>">
...
<!--            <li class="am-cf" style="position:relative;">
        ...
        <p class="bank_pass" style="display: inline-block;"><a  href="<?php echo U('Public/forgetPaw');?>">忘记密码?</a></p>
        <p class="bank_pass " style="text-align: center;display: inline-block;"><a href="<?php echo U('Public/register');?>">没有账号? 立即注册</a></p>
        </div>
    </form>
</div>
<script>
