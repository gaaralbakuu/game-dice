...
<script type="text/javascript" src="/Template/Mobile/js/ssc.js"></script>
<script type="text/javascript" src="/Template/Mobile/js/tabGame.js"></script>
...
<section class="" id="gamepage">
    ...
    <div class="mobileGameTop">
        ...
        <div class="play_select_insert" id="j_play_select">
            <ul class="play_select_tit" style="overflow:hidden;">
                ...
                <li lottery_code="lh">龙虎斗
                    <em class="newPlayType"></em>
                </li>
                <li lottery_code="xyp" class="curr">信用盘
                    <em class="newPlayType"></em>
                </li>
            </ul>
            <!--玩法二级选项开始-->
    ...
    <div class="open_containers g_Time_Section">
        ...
        <div class="cz_openNumb">
            ...
            <div class="open_issue" id="showTabel"><span class="c_red" way-data="showExpect.lastFullExpect"
                                                         id="f_lottery_info_lastnumber" firstissueno="">---
                </span>期开奖号码
            </div>
            ...
            <i onclick="" class="iconfont icon-jiantouxia my_jiantouxia cz_daojishi" id="showTabel"></i>
        </div>
        <!--彩种开奖号码-->
    </div>
            ...
            document.getElementById('my_input_money').value = "";
              ...
              元
                            ...
                            <div class="selectMultipleB addtobetbtn">
                                ...
                                <span class="select_zhushu">共<em class="zhushu">0</em>注,</span>
                                <span class="selectMultipleOld">共<em class="selectMultipleOldMoney">0.00</em>元</span>
                                <div class="selectMultipleB_n" id="selectMultipleB_nId">

                                </div>
                            </div>
                            <div class="selectMultipleLz" id="selectMultipleLz_show">
                                <span class="lanIconNumber" id="lanIconNumbere">0</span>
...
<script>
    ...
    $(document).on('click', '#showTabel,.showTabel', function () {
