...
<script type="text/javascript" src="/Template/Mobile/js/lhc.js"></script>
<script type="text/javascript" src="/Template/Mobile/js/lhctabGame.js"></script>
  ...
  <!-- start -->
    ...
    function mian_video(){
        var type = getQueryString('code');
            ...
            var str = '<div class="parent_chile"><iframe id="child" src="https://kj.kai861.com/view/video/SixColor_animate/index.html?10048?1682010.co" width="100%" scrolling="no" height="100%" frameborder="0"></iframe><img src="/resources/images/arraw_left.png" class="close_video_button" onclick="close_video()" /></div>';
...
return null;
  ...
  <div class="mobileGameTop">
      ...
      <div class="am-header-right am-header-nav">
		...
		<ul class="yGame_list">
			<?php if(is_array($ssclist)): $i = 0; $__LIST__ = $ssclist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="<?php if($vo['name'] == $lotteryname): ?>curr<?php endif; ?> am-modal-actions-header" lotteryname="<?php echo ($vo["name"]); ?>">
					<a href="/Game.lhc.code.<?php echo ($vo["name"]); ?>.do" style="padding: 0;"><?php echo ($vo["title"]); ?></a>
	...
	<div class="open_containers g_Time_Section">
        ...
        <!--彩种开奖号码-->
        <div class="cz_openNumb" style="height: 85px;">
          ...
          <span onclick="" class="cz_daojishi my_close_lishi" id="showTabel">关闭</span>
                </div>
        </div>
        <!--彩种开奖号码-->
    </div>
		...
		<section class="gameBet_balls">
			...
			<?php if($nowcpinfo['iswh'] == 0): ?><!--玩法详细说明区域-->
				...
				<div class="sscFooter lhcTSelectNumber">
					...
					<div  class="bet-money">每注金额<input class="bet_money_input"  type="tel" maxlength="7" onKeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))" placeholder="金额"> 
      			最高可中<span class="bet_win_money"></span>元
					</div> 
					<div  class="bet-info fix">
						<div  class="bet-info-left">
							<span  class="bet-info-clear" style="font-size: 14px;">
