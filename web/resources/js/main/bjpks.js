...
var str = `<div id="popup_box" style="width: 100%;height: 100vh;display:none; z-index: 1000; margin: 0px;padding: 0px;top: 0px;left: 0px; position: fixed; background-color: rgba(55,55,55,.6);">
		<div style="width: 400px;height: 450px;text-align: center; margin: 0 auto;margin-top: 50vh;position: relative; top: -225px;">
			...
			<img src="./zhong.png" style="width: 400px;">
			<span id="popup_text" style="font-size: 18px;font-weight: 700;top: -50px;position: relative; color: #ffdc37;">恭喜您中奖了，具体详情请到投注记录查看哦！</span>
		</div>
	</div>`;
	$('body').append(str);
  lotteryname = null;
