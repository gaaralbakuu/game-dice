...
<header class="header" style="height:30px;">
    ...
    <li style="padding:0;line-height: 49px;">
        <a href="tencent://message/?Menu=yes&uin={:GetVar('kefuqq')}&Site=腾讯爱好者&Service=300&sigT=45a1e5847943b64c6ff3990f8a9e644d2b31356cb0b4ac6b24663a3c8dd0f8aa12a595b1714f9d45"  target="_blank">
    ...
    <div class="nav">
        <div class="container fix">
            ...
            <ul class="navItem fix flr" style="position: relative;">
                ...
                <!---->
                <!-- <li class=""><a href="{:U('Index/zrvideo')}">真人视讯</a></li> -->
                <li class=""><a href="{:U('Index/lottery')}">购彩大厅</a></li>
                <!---->
                <li class=""><a href="{:U('Activity/index')}">活动中心</a></li>
                <!---->
                <li class=""><a href="{:U('Index/mobile')}">手机购彩</a></li>
                <!---->
