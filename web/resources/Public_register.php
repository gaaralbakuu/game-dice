	...
	<div class="login_bg" style="height:540px">
		...
		<div class="login_input">
			<form method="post" id="form1" class="ruivalidate_form_class" checkby_ruivalidate  onSubmit="return check_form(this)"  action="{:U('Public/register')}">
				...
				<div class="login_pass user_commom_style">
					<span>资金密码：</span>
					<input  type="password" id="tradepassword" placeholder="请输入资金密码"  class="text_accont" style="border-radius:4px;"  name="tradepassword" datatype="*6-16" recheck="password" nullmsg="请输入资金密码！"/>
					<em class="checkInput">
						<i class="iconfont"></i>
						<span></span>
					</em>
