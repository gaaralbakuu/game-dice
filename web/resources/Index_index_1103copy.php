                            ...
                            <switch name="cp.typeid">
                                <case value="k3">
                                    <a href="__ROOT__/Game.k3?code={$cp[name]}" title="{$cp[ftitle]}">
                                        <i class="iconfont"><img src="/app/k3.gif" style="width:38px"/></i>
                                </case>
                                <case value="lhc">
                                    <a href="__ROOT__/Game.lhc?code={$cp[name]}" title="{$cp[ftitle]}">
                                        <i class="iconfont" style="color:#07b39e"><img src="/app/lhc.png" style="width:38px"/></i>
                                </case>
                                <case value="ssc">                                                                                                                               <a href="__ROOT__/Game.ssc?code={$cp[name]}" title="{$cp[ftitle]}">
                                        <i class="iconfont special " ><img src="/app/ssc.png" style="width:38px"/></i>
                                </case>
                                <case value="pk10">
                                    <a href="__ROOT__/Game.pk10?code={$cp[name]}" title="{$cp[ftitle]}">
                                        <i class="iconfont " style="color:#f22751" ><img src="/app/pk10.png" style="width:38px"/></i>
                                </case>
                                <case value="keno">
                                    <a href="__ROOT__/Game.keno?code={$cp[name]}" title="{$cp[ftitle]}">
                                        <i class="" style="color:#fc5826" ><img src="/app/kl8.png" style="width:38px"/></i>
                                </case>
                                <case value="x5">
                                    <a href="__ROOT__/Game.x5?code={$cp[name]}" title="{$cp[ftitle]}">
                                       <i class="iconfont"><img src="/app/115.png" style="width:38px"/></i>
                                </case>
                                <case value="dpc">
                                    <a href="__ROOT__/Game.dpc?code={$cp[name]}" title="{$cp[ftitle]}">
                                        <i class="iconfont <?php if(strstr($cp['name'],'3d')){}else{}?>"><?php if(strstr($cp['name'],'3d')){ ?><img src="/app/3d.png" style="width:38px"><?php } ?><?php if(strstr($cp['name'],'pl3')){ ?><img src="/app/pl3.png" style="width:38px"><?php } ?></i>
                                </case>
                            </switch>
                            <em>{$cp[title]}</em>
