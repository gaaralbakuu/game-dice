...
<!--                <i class="icon-11xuan5 iconfont common_lottery_icon" style="color:#218ddd;"></i>-->
	...
	function mian_video(){
		var type = $('.lottery_title_h2').html();
			...
			var str = '<div class="parent_chile"><iframe id="child" src="https://kj.kai861.com/view/video/11x5_video/index.html?10006?1682010.co" width="100%" scrolling="no" height="100%" frameborder="0"></iframe><img src="__ROOT__/resources/images/arraw_left.png" class="close_video_button" onclick="close_video()" /></div>';
				$('#video_box').append(str);
			}else if(type == '上海11选5'){
				$('.start_video').css("display","block");
				var str = '<div class="parent_chile"><iframe id="child" src="https://kj.kai861.com/view/video/11x5_video/index.html?10018?1682010.co" width="100%" scrolling="no" height="100%" frameborder="0"></iframe><img src="__ROOT__/resources/images/arraw_left.png" class="close_video_button" onclick="close_video()" /></div>';
				$('#video_box').append(str);
			}else if(type == '江西11选5'){
				$('.start_video').css("display","block");
				var str = '<div class="parent_chile"><iframe id="child" src="https://kj.kai861.com/view/video/11x5_video/index.html?10015?1682010.co" width="100%" scrolling="no" height="100%" frameborder="0"></iframe><img src="__ROOT__/resources/images/arraw_left.png" class="close_video_button" onclick="close_video()" /></div>';
				$('#video_box').append(str);
			}
        }
	}
