						...
						<div id="pay_alipay" class="me-infor" style="display:none;">
							<div class="infor-xx">
								...
								<div>
									...
									扫码付款后，请点击提交
									<a class="btn common_btn" style="width:10em;display:block;margin:1em auto;" href="javascript:;" onclick="alt('充值申请已成功提交'); window.location.href = '{:U('Account/dealRecord2')}'">提交</a>
								</div>
							</div>
						</div>
						<div class="prompt">
