    ...
    <div class="container">
         <div style="position: fixed;top: 0px;left: 0px;width: 100%;">
            <div style="position: fixed;width: 130px;height: 500px;left: 10px;top: 106px;">
                <img src="__ROOT__/resources/images/left_banner.png" style="width: 130px;">
                <div style="width: 100px;margin: 0 auto;border-radius: 5px; height: 300px;background-color: #f72222;color: white;font-size: 26px;line-height: 40px;position: relative; text-align: center;">
                    <br>投<br>入<br>梦<br>想
                    <img src="__ROOT__/resources/images/hua.png" style="width: 130px;position: absolute;bottom: -10px;right: -30px;">
                </div>
            </div>
                ...
                <div class="login clearfix">
                    ...
                    <div class="login-box">
                        <if condition="is_array($userinfo)">
                            <div class="login">
                                ...
                                <div class="info-list clearfix">
                                    <label><a href="{:U('Member/betRecord')}" target="_blank">投注记录</a></label>
                            ...
                            <div class="not-login">
                                <div class="welcome">
                                    <label>Hi，欢迎来到{:GetVar('webtitle')}</label>
                                </div>
                        ...
                        <div class="help-tab-box">
                            ...
                            <ul class="help-ul">
                                <li>
                                    <a href="{:U('News/lists',array('catid'=>33))}" target="_blank">如何注册彩票网会员？</a>
                                </li>
                                <li>
