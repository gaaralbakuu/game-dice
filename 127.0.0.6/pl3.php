...
https://api.api861861.com/QuanGuoCai/getLotteryInfo1.do?&lotCode=10043
$api = 'http://api.api68.com/QuanGuoCai/getLotteryInfo1.do?&lotCode=10043';
...
echo '{"sign":true,"message":"获取成功","data":[{"title":"排列3","name":"pl3","expect":"'.$rq.'","opencode":"'.$hm.'","opentime":"'.str_replace('/','-',$sj).'","source":"开彩采集","sourcecode":""}]}';
