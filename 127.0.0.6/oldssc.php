...
/*		$array = array();
 ...
 function rand_keys($len = 5,$str='0123456789') {
		$rand = '';
		for ($x=0;$x<$len;$x++) {
...
*/
?>
{"sign":true,"message":"获取成功","data":{"<?=intval(substr($predraws['expect'],-3))?>":{"title":"老重庆时时彩","name":"oldssc","expect":"<?=$predraws['expect']?>","opencode":"<?=rand_keys()?>","opentime":"<?=$predraws['end']?>","source":"系统彩","sourcecode":""}}}